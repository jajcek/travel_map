...
class OcadoExperienceDescription extends React.Component<{}, {}> {
    render() {
        return (
            ...
            >
                <p>
                    Officially I was hired as a C++ developer (by passing C++ interview) and worked on some smaller tasks,
                    but after two months I started working with Java for almost two years.
                    In Java we were developing a tool for presenting BTS (Base Transceiver Station) parameters in
                ...
                <p>
                    After some time we decided to move to web technologies like AngularJS, jQuery, Grunt, Bower, Node, Git etc.
                </p>
            </ExperienceDescription>
        );
    }
